...
class TrashPageGrid extends StatefulWidget {
  const TrashPageGrid({Key? key}) : super(key: key);

  @override
  State<TrashPageGrid> createState() => _TrashPageGridState();
}

class _TrashPageGridState extends State<TrashPageGrid> {
